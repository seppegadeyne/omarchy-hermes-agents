...
Panel {
  ...
  function launchAgent() {
    if (root.bar) root.bar.run("omarchy-launch-tui --app-id=org.omarchy.agent hermes chat --tui --yolo")
    root.close()
  }
  ...
  KeyboardPanel {
    ...
    // Wider than stock: with four providers the switch buttons need more room.
